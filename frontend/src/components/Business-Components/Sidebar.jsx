...
export default function BusSidebar() {
    ...
    return (
        <div className="sticky top-0 left-0 bottom-0 h-screen py-0 px-4 text-white bg-[#8FD8CF] transition-all duration-500 w-20 sm:w-[344px]">
                ...
                <li className={`p-3 my-2 rounded-lg transition duration-500 ease-in-out ${location.pathname.startsWith('/business/dashboard') ? 'bg-white' : ''} hover:bg-white ${dashboardDropdown ? 'bg-white' : ''}`}>
                    <div className="flex items-center justify-between cursor-pointer" onClick={toggleDashboardDropdown}>
                        <Link to='/business/dashboard' className="flex items-center gap-3">
                            ...
                            <Link to='/business/dashboard' className="text-sm text-black hidden lg:block">Dashboard</Link>
                        </Link>
                    ...
                    {dashboardDropdown && (
                        <ul className="mt-2 ml-10 hidden lg:block">
                            ...
                            <li className='p-2 my-1 rounded-lg transition duration-500 ease-in-out hover:bg-[#8FD8CF]'>
                                <Link to='/business/dashboard/pending' className="text-black text-sm no-underline">Pending Assignments</Link>
                            </li>
                            <li className='p-2 my-1 rounded-lg transition duration-500 ease-in-out hover:bg-[#8FD8CF]'>
                                <Link to='/business/dashboard/review' className="text-black text-sm no-underline">Review Assignments</Link>
                            </li>
                            <li className='p-2 my-1 rounded-lg transition duration-500 ease-in-out hover:bg-[#8FD8CF]'>
                                <Link to='/business/dashboard/completed' className="text-black text-sm no-underline">Completed Assignments</Link>
                            </li>
                        </ul>
                    )}
                </li>
