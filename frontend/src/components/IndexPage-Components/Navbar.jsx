    ...
    <nav className="bg-white shadow-md">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden sm:flex sm:gap-12 sm:space-x-8">
          ...
          <div className="relative flex items-center" ref={dropdownRef}>
            ...
            {dropdownVisible && (
              <div className="absolute right-0 mt-64 w-72 bg-[#A3D5F2] border rounded-md shadow-lg z-10 p-4" style={{ backgroundImage: 'url(/path/to/your/background/image.png)', backgroundSize: 'cover' }}>
                <Link to={'/business/signup'} className="flex items-center px-4 py-2 hover:bg-white text-md text-black rounded-md mb-2">
                ...
                <Link to={'/creator/signup'} className="flex items-center px-4 py-2 hover:bg-white text-md text-black rounded-md">
                  <div className='bg-[#FFFFFF] h-14 w-14 rounded-xl flex items-center justify-center mr-4'>
                    <img src="/IndexPage-assests/creator.png" alt="Creator Icon" className="h-8 w-8" />
                  </div>
                  AS A CREATOR
                </Link>
              </div>
