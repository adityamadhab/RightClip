...
export default function SetUpStep4({ nextStep, prevStep }) {
    return (
                    ...
                    <div className="max-w-md w-full space-y-8 p-10">
                        ...
                        <form className="mt-8 space-y-6" onSubmit={(e) => { e.preventDefault(); nextStep(); }}>
                            <div className="rounded-md shadow-sm space-y-4">
                                <div>
                                    <label htmlFor="linkedin" className="block mb-1 text-sm font-medium text-black">Demo question?</label>
                                    <input id="linkedin" name="linkedin" type="text" required className="appearance-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-2xl focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" />
                                </div>
                                <div>
                                    <label htmlFor="linkedin" className="block mb-1 text-sm font-medium text-black">Demo question?</label>
                                    <input id="linkedin" name="linkedin" type="text" required className="appearance-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-2xl focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" />
