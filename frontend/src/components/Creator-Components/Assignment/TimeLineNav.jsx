        ...
        <div className="p-4">
            <div className="flex justify-between gap-6 items-center mb-4">
                ...
                <Link 
                    ...
                    className={`text-black border border-[#929292] px-4 py-2 rounded-xl flex justify-start w-[300px] cursor-pointer ${location.pathname === '/creator/assignment/timelines/feedback' ? 'bg-[#ABCAF8]' : 'bg-white'}`}
                >
                    <p className="text-sm">View Feedback</p>
                </Link>
                <Link 
                    to={'/creator/assignment/timelines/status'} 
                    className={`text-black border border-[#929292] px-4 py-2 rounded-xl flex justify-start w-[300px] cursor-pointer ${location.pathname === '/creator/assignment/timelines/status' ? 'bg-[#ABCAF8]' : 'bg-white'}`}
                >
