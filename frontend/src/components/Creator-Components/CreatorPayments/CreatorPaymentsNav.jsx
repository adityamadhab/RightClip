...
export default function CreatorPaymentsNav() {
    return (
        <div className="border-b-2 border-[#E7CBA3] bg-white w-full sm:w-[1200px] mb-6">
            <div className="bg-white mb-3 flex justify-between items-center">
                <Link to={'/dashboard'} className="header--title cursor-pointer flex gap-4">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className='h-5 w-5 mt-1'>
                    ...
                    <h2 className="text-lg font-extrabold text-black hidden sm:block">Payments</h2>
                    <h2 className="text-sm font-bold text-black sm:hidden mt-1">Payments</h2>
                </Link>
            </div>
        </div>
    )
