...
export default function CreMessageNav() {
    return (
        <div className="border-b-2 border-[#E7CBA3] bg-white w-[1200px] mb-2">
            <div className="bg-white mb-3 flex justify-between items-center">
                <Link to={'/dashboard'} className="header--title cursor-pointer flex gap-4">
                    ...
                    <h2 className="text-lg font-extrabold text-black">Inbox</h2>
                </Link>
            </div>
        </div>
    )
