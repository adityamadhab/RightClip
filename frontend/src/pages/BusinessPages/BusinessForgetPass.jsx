...
export function BusForgotPassword() {
    ...
    const handleEmailSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('/business/forgot-password', { email });
    ...
    const handlePasswordReset = async (e) => {
        ...
        try {
            const response = await axios.post('/business/reset-password', { email, otp, newPassword });
            if (response.status === 200) {
        ...
        <div className="min-h-screen flex flex-col lg:flex-row">
            <div className="w-full lg:w-2/3 flex items-center justify-center bg-white">
                <div className="max-w-md w-full space-y-8 p-10">
                    ...
                    {step === 3 && (
                        <div className="text-center">
                            <p>Your password has been reset successfully. You can now <Link to={'/business/signin'} className='text-blue-400 hover:text-blue-600'>log in</Link> with your new password.</p>
                        </div>
                    )}
                </div>
            </div>
