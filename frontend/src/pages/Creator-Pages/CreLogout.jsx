            ...
            <div className="bg-white w-full p-4 flex flex-col justify-center items-center overflow-x-hidden">
                <div className="border-b-2 border-[#E7CBA3] bg-white w-full sm:w-[1200px] mb-6">
                    <div className="bg-white mb-3 flex justify-between items-center">
                        <Link to={'/creator/dashboard'} className="header--title cursor-pointer flex gap-4">
                            ...
                            <h2 className="text-lg font-extrabold text-black hidden sm:block">Logout</h2>
                            <h2 className="text-sm font-bold text-black sm:hidden mt-1">Logout</h2>
                        </Link>
                    </div>
                </div>
